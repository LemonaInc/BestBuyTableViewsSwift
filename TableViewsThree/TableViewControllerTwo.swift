...
class TableViewControllerTwo: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tableView.register(UINib(nibName: "TableViewCell", bundle: nil), forCellReuseIdentifier: "TableViewCellTwo")
        getNetworkData()
            ...
            if let data = data, let json = try? JSONSerialization.jsonObject(with: data, options: []),
                ...
                if let subCategoriesArray = dict["subCategories"] as? [[String: Any]] {
                    ...
                    for subCategory in subCategoriesArray {
                        ...
                        if let categoryId = subCategory["id"] as? String, let name = subCategory["name"] as? String, let hasSubcategories = subCategory["hasSubcategories"] as? Bool, let productCount = subCategory["productCount"] as? Int {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.productIdLabel.text = categoryArray[indexPath.row].name
